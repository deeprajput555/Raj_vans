...
if (((@$_FILES['profilepic']['type']=='image/jpeg') || (@$_FILES['profilepic']['type']=='image/png') || (@$_FILES['profilepic']['type']=='image/gif')) && (@$_FILES['profilepic']['size'] < 100000000000000)) {
		...
		<div class="categolis">
			<table>
				<tr>
					...
					<?php 
						if($utype_db == 'admin'){
							echo '<th><a href="newadmin.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;;border-radius: 12px;">New Admin</a></th>';
						}
					?>
  											...
  											<h5>Item:</h5>
												...
												<select name="item" required="required" style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: #169E8F;margin-left: 195px;width: 300px;background-color: transparent;" class="">
																<option selected value="Kurta">Kurta</option>
																<option value="Jacket">Jacket</option>
																<option value="Jodhpuri Suits">Jodhpuri Suits</option>
																<option value="Mala">Mala</option>
																<option value="Mojadi">Mojadi</option>
																<option value="safa_dupatta">safa_dupatta</option>
																<option value="Sherwani">Sherwani</option>
																<option value="Shortkurta">Shortkurta</option>
												</select>
												</td>
											</div></br>
